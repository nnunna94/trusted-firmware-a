...
static void clock_disable_boot_imem(void)
{
	...
	for (delay = 500U;
	     delay != 0U && (mmio_read_32(GCC_CFG_NOC_LPASS_CBCR) & HAL_CLK_BRANCH_CTRL_REG_CLK_OFF_FMSK) != 0U;
	     delay--)
		udelay(1U);

	mmio_setbits_32(LPASS_LPASS_TOP_CC_LPI_Q6_AXIM_HS_CBCR, HAL_CLK_BRANCH_CTRL_REG_CLK_ENABLE_FMSK);
	for (delay = 500U;
	     delay != 0U && (mmio_read_32(LPASS_LPASS_TOP_CC_LPI_Q6_AXIM_HS_CBCR) & HAL_CLK_BRANCH_CTRL_REG_CLK_OFF_FMSK) != 0U;
	     delay--)
		udelay(1U);
