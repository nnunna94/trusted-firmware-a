...
#define CHIPINFO_MODEM_1XEVDO_REVA \
	(CHIPINFO_MODEM_1XEVDO | CHIPINFO_MODEM_EVDO_REVA)
#define CHIPINFO_MODEM_1XEVDO_REVB \
	(CHIPINFO_MODEM_1XEVDO_REVA | CHIPINFO_MODEM_EVDO_REVB)
#define CHIPINFO_MODEM_WWAN \
	(CHIPINFO_MODEM_1XEVDO_REVB | CHIPINFO_MODEM_GSM | CHIPINFO_MODEM_UMTS)
 ...
 */
typedef uint32_t chipinfo_version_t;

/*
 * chipinfo_modem_t. Stores the info about the modem
 * hardware supported on the platform.
 */
typedef uint32_t chipinfo_modem_t;
 ...
 */
typedef uint32_t chipinfo_serial_num_t;

/*
 * Chip serial number as read from QFPROM.
 */
typedef uint32_t chipinfo_qfprom_chip_id_t;
...
/*
 * Supported parts by the GetDisabledFeatures API.
 ...
 */
typedef struct {
	chipinfo_feature_code_t feature_code;
	chipinfo_p_code_t p_code;
} chipinfo_sku_t;
